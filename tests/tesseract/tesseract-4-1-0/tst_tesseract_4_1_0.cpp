...
class tesseract_4_1_0 : public QObject
{
    Q_OBJECT
...
tesseract_4_1_0::tesseract_4_1_0() { }

tesseract_4_1_0::~tesseract_4_1_0() { }

void tesseract_4_1_0::initTestCase()
{
...
void tesseract_4_1_0::cleanupTestCase()
{
  m_tess->End();
  pixDestroy(&m_image);
}

void tesseract_4_1_0::test_GetUTF8Text()
{
  QString expected = \
...
#ifdef BENCHMARKS
void tesseract_4_1_0::benchmark_getUTF8Text()
{
  QBENCHMARK {
    for(int i = 0; i < 10; ++i)
    {
...
QTEST_MAIN(tesseract_4_1_0)

#include "tst_tesseract_4_1_0.moc"
