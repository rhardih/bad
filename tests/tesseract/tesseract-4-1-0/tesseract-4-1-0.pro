...
SOURCES +=  tst_tesseract_4_1_0.cpp

android {
  equals(ANDROID_TARGET_ARCH, armeabi-v7a) {
    BUILD_PATH = $$(BAD_PATH)/extracted/tesseract-4.1.0-armv7-a-build
  ...
  equals(ANDROID_TARGET_ARCH, arm64-v8a) {
    BUILD_PATH = $$(BAD_PATH)/extracted/tesseract-4.1.0-arm64-v8a-build
  ...
  equals(ANDROID_TARGET_ARCH, x86) {
    BUILD_PATH = $$(BAD_PATH)/extracted/tesseract-4.1.0-x86-build
