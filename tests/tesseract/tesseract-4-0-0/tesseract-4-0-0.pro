...
android {
  equals(ANDROID_TARGET_ARCH, armeabi-v7a) {
    # tesseract
    LIBS += -L$$(BAD_PATH)/extracted/tesseract-4.0.0-armv7-a-build/lib/ -ltesseract
    INCLUDEPATH += $$(BAD_PATH)/extracted/tesseract-4.0.0-armv7-a-build/include
    ...
    ANDROID_EXTRA_LIBS += \
      $$(BAD_PATH)/extracted/tesseract-4.0.0-armv7-a-build/lib/libtesseract.so \
