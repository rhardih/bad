...
SOURCES +=  tst_tesseract_3_05_01.cpp

android {
  equals(ANDROID_TARGET_ARCH, armeabi-v7a) {
    # tesseract
    LIBS += -L$$(BAD_PATH)/extracted/tesseract-3.05.01-armv7-a-build/lib/ -ltesseract
    INCLUDEPATH += $$(BAD_PATH)/extracted/tesseract-3.05.01-armv7-a-build/include
    ...
    ANDROID_EXTRA_LIBS += \
      $$(BAD_PATH)/extracted/tesseract-3.05.01-armv7-a-build/lib/libtesseract.so \
