...
class gdal_2_4_0 : public QObject
{
    Q_OBJECT
...
void gdal_2_4_0::cleanupTestCase() {
  GDALClose(m_poDataset);
}

void gdal_2_4_0::test_GetRaster_()
{
...
void gdal_2_4_0::test_GetDriverName()
{
  QCOMPARE(m_poDataset->GetDriverName(), "GTiff");
}

QTEST_APPLESS_MAIN(gdal_2_4_0)

#include "tst_gdal_2_4_0.moc"
